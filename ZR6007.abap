...
* Utilizand o comando READ TABLE
READ TABLE T_FORNEC INDEX 2. " Forçando a leitura do registro 2
IF SY-SUBRC = 0.
...
* CONCATENATE - adicionando a descrição dos produtos com um texto
  MODIFY T_MATERIAL FROM W_MATERIAL TRANSPORTING DESCRI.
* MODIFY tabela interna SEM HEADER LINE, ENTÃO USA FROM W_MATERIAL
* O MODIFY vai alterar somente o campo DESCRI
ENDLOOP.
